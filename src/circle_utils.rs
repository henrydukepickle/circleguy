...
///compares two points along a circle, given a base point--essentially, traveling along a circle (counterclockwise) from base, which point do you encounter first?
///a point equal to the base is minimal
///arbitrary when A is approximately B
